"""
A Network Engineer has created this Python script(network_engineer_02.py) that executes show ip interface brief
on a remote Cisco Router and displays the output.
...
# output is byte object, we have to convert it to a string using decode()
